 ...
 *
 * camera helper for tc358743 sensor
 */
 ...
 * I2C addresses from the Sony tc358743 datasheet:
 */
...
class CamHelperTc358743 : public CamHelper
{
public:
	CamHelperTc358743();
...
CamHelperTc358743::CamHelperTc358743()
	: CamHelper(std::make_unique<MdParserSmia>(registerList), frameIntegrationDiff),
	  aeHistLinear_{}, aeHistAverage_(0), aeHistValid_(false)
{
}

uint32_t CamHelperTc358743::gainCode(double gain) const
{
	return static_cast<uint32_t>(1024 - 1024 / gain);
}

double CamHelperTc358743::gain(uint32_t gain_code) const
{
	return 1024.0 / (1024 - gain_code);
}

void CamHelperTc358743::prepare(libcamera::Span<const uint8_t> buffer, Metadata &metadata)
{
...
void CamHelperTc358743::process(StatisticsPtr &stats, [[maybe_unused]] Metadata &metadata)
{
	if (aeHistValid_)
		putAGCStatistics(stats);
}

std::pair<uint32_t, uint32_t> CamHelperTc358743::getBlanking(Duration &exposure,
...
void CamHelperTc358743::getDelays(int &exposureDelay, int &gainDelay,
...
bool CamHelperTc358743::sensorEmbeddedDataPresent() const
{
	return true;
}

double CamHelperTc358743::getModeSensitivity(const CameraMode &mode) const
{
	/* In binned modes, sensitivity increases by a factor of 2 */
	return (mode.width > 2304) ? 1.0 : 2.0;
}

unsigned int CamHelperTc358743::hideFramesModeSwitch() const
{
	/*
...
unsigned int CamHelperTc358743::hideFramesStartup() const
{
	return hideFramesModeSwitch();
}

void CamHelperTc358743::populateMetadata(const MdParser::RegisterMap &registers,
...
bool CamHelperTc358743::parsePdafData(const uint8_t *ptr, size_t len,
...
bool CamHelperTc358743::parseAEHist(const uint8_t *ptr, size_t len, unsigned bpp)
{
...
void CamHelperTc358743::putAGCStatistics(StatisticsPtr stats)
{
	/*
...
{
	return new CamHelperTc358743();
}

static RegisterCamHelper reg("tc358743", &create);

//#static RegisterCamHelper regWide("tc358743_wide", &create);
//#static RegisterCamHelper regNoIr("tc358743_noir", &create);
//#static RegisterCamHelper regWideNoIr("tc358743_wide_noir", &create);
